...
const static char DEVICE_NAME[] = "MAGNETOMETER";
...
public:
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magneto_uuid(0xA000),
        _magneto_service(ble, pDataXYZ),
...
private:
    ...
    void update_sensor_value()
    {
        ...
        BSP_MAGNETO_GetXYZ(rDataXYZ);
        /*  60 <= bpm value < 110 */
        pDataXYZ[0]=int(rDataXYZ[0]);
        pDataXYZ[1]=int(rDataXYZ[1]);
        pDataXYZ[2]=int(rDataXYZ[2]);
        _magneto_service.updateMagnetoIntensity(pDataXYZ);
    }
